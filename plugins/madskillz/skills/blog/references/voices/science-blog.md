...
- **Casual lowercase, typos left in flight** ("lets do worktree", "tha tmight", "shoudl", "I"ll") —
  *tone-down*: the unfussed *directness* is me; the typos are not. Clean them.
...
- **Meta self-narration** of my own thinking ("The more I think about this the more I think…") —
  *keep*: it suits learning-journey posts.
- **Enthusiasm markers** — "freaking cool" *keep* (sparingly; signature); trailing "etc." and ".."
  *tone-down* (crutch).
...
- **Question stacking**: I fire 3–5 chained questions in one breath; the pile-up *is* the thinking —
  *keep the device, tone-down the volume*: in prose, curate to the 1–2 sharpest.
- **Hypothetical thought experiments** ("if I filled a perfectly reflective box with light to the
  brim…", "if I had a material with no slots, would it never heat up?") — *keep*: my best
  explanatory move.
